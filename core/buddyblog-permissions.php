 ...
 * @return bool
 */
function buddyblog_user_can_publish( $user_id, $post_id = 0 ) {
 ...
 * @return bool
 */
function buddyblog_user_can_post( $user_id = 0 ) {
	// non logged in users can not post.
	$can_post = false;
 ...
 * @return bool
 */
function buddyblog_user_can_edit( $post_id, $user_id = 0 ) {
 ...
 * @return bool
 */
function buddyblog_user_can_delete( $post_id, $user_id = 0 ) {
